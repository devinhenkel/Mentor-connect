      ...
      <div className="mx-auto max-w-xl space-y-6">
        <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link
              href="/"
              className="inline-flex items-center justify-center rounded-lg border border-border bg-white px-4 py-2.5 text-sm font-semibold text-zinc-900 hover:bg-surface-muted"
            >
              Find another mentor
            </Link>
          </div>
    ...
    <div className="mx-auto max-w-xl space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          Session: <span className="font-medium text-zinc-800">{slot}</span>
        </p>

        <div className="mt-6">
          <div className="text-sm font-medium text-zinc-800">Rating</div>
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            rows={5}
            className="mt-2 w-full rounded-xl border border-border bg-white px-3 py-3 text-sm text-zinc-900 shadow-sm outline-none ring-primary/30 placeholder:text-zinc-400 focus:ring-4"
